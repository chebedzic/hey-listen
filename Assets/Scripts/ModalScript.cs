...
public class ModalScript : MonoBehaviour
{
    ...
    public void SetEditMode(bool state)
    {
        ...
        transform.DOMove(state ? new Vector3(worldCenter.x, transform.position.y + 3, desiredZPosition - 2) : originalPosition, .25f).SetEase(state ? Ease.OutBack : Ease.OutSine);
    }
